...
def weather_energy_cluster():
    ...
    st.markdown("""There is a lot of process behind this. But let me make it straightforward. We analyzed the relationships between 'Average Temperature', 'Cooling Degree Days', 'Heating Degree Days' to see their impact on all types of 
    energy consumptions (Residential, Commercial, Industrial, Transportation, and all combined). We captured similar behaviors (energy consumption vs temperature) between the states and projected those behaviors onto map, 
    by dividing these behaviours into different groups. And voila, these behaviours formed these interesting borders, indicating that there is regional pattern in energy consumptions. I ideally would love the divided groups to be 4, but 
    I would love for you to play around and see what happens if you split these behaviors into 3 or 5 or 6 groups. :)""")
